...
contract PayvergeProfitSplitTest is Test {
    ...
    function testCalculatePayouts() public {
        ...
        (address[] memory beneficiaryAddrs, uint256[] memory payouts) = 
            profitSplit.calculatePayouts(testAmount);
    ...
    function testGetDistributionStats() public {
        ...
        (uint256 balance, uint256 totalDist, uint256 distCount, uint256 lastDist) = 
            profitSplit.getDistributionStats();
