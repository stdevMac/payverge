...
contract AlternativePaymentsTest is Test {
    ...
    function setUp() public {
        ...
        payments.createBill(testBillId, business, BILL_TOTAL, "Test Bill", keccak256("test-nonce"));
    ...
    function testBasicAlternativePayment() public {
        ...
        PayvergePayments.AlternativePayment[] memory altPayments = payments.getBillAlternativePayments(testBillId);
    ...
    function testAlternativePaymentExactBillTotal() public {
        ...
        vm.prank(billManager);
        payments.markAlternativePayment(testBillId, customer1, BILL_TOTAL, PayvergePayments.PaymentMethod.CASH);
    ...
    function testAlternativePaymentExceedsBillTotal() public {
        ...
        payments.markAlternativePayment(testBillId, customer1, BILL_TOTAL + 1, PayvergePayments.PaymentMethod.CASH);
    }
    ...
    function testMixedCryptoAndAlternativePayments() public {
        ...
        vm.prank(billManager);
        payments.markAlternativePayment(testBillId, customer2, 40 * 10 ** 6, PayvergePayments.PaymentMethod.CASH);

        // Then, card payment of $30 (should complete bill)
        vm.prank(billManager);
        payments.markAlternativePayment(testBillId, customer3, 30 * 10 ** 6, PayvergePayments.PaymentMethod.CARD);
    ...
    function testMultipleAlternativePaymentsSamePerson() public {
        ...
        vm.prank(billManager);
        payments.markAlternativePayment(testBillId, customer1, 20 * 10 ** 6, PayvergePayments.PaymentMethod.CASH);

        // Same customer pays $30 card
        vm.prank(billManager);
        payments.markAlternativePayment(testBillId, customer1, 30 * 10 ** 6, PayvergePayments.PaymentMethod.CARD);

        // Check participant info
        (uint256 paidAmount, uint32 paymentCount,) = payments.getParticipantInfo(testBillId, customer1);
    ...
    function testUnauthorizedAlternativePayment() public {
        ...
        vm.prank(attacker);
        vm.expectRevert();
        payments.markAlternativePayment(testBillId, customer1, 50 * 10 ** 6, PayvergePayments.PaymentMethod.CASH);
    ...
    function testAlternativePaymentOnNonExistentBill() public {
        ...
        payments.markAlternativePayment(fakeBillId, customer1, 50 * 10 ** 6, PayvergePayments.PaymentMethod.CASH);
    }

    function testAlternativePaymentZeroAmount() public {
        vm.prank(billManager);
        vm.expectRevert("Invalid amount");
        payments.markAlternativePayment(testBillId, customer1, 0, PayvergePayments.PaymentMethod.CASH);
    }

    function testAlternativePaymentZeroAddress() public {
        vm.prank(billManager);
        vm.expectRevert("Zero address");
        payments.markAlternativePayment(testBillId, address(0), 50 * 10 ** 6, PayvergePayments.PaymentMethod.CASH);
    }
    ...
    function testAlternativePaymentWithCryptoMethod() public {
        ...
        payments.markAlternativePayment(testBillId, customer1, 50 * 10 ** 6, PayvergePayments.PaymentMethod.CRYPTO);
    }
    ...
    function testAlternativePaymentOnAlreadyPaidBill() public {
        ...
        payments.markAlternativePayment(testBillId, customer2, 10 * 10 ** 6, PayvergePayments.PaymentMethod.CASH);
    }
    ...
    function testAlternativePaymentRaceCondition() public {
        ...
        vm.prank(billManager);
        vm.expectRevert("Exceeds bill total");
        payments.markAlternativePayment(testBillId, customer2, 20 * 10 ** 6, PayvergePayments.PaymentMethod.CASH);
    ...
    function testMassiveAlternativePaymentFragmentation() public {
        ...
        for (uint256 i = 0; i < 100; i++) {
            ...
            vm.prank(billManager);
            payments.markAlternativePayment(bigBillId, customer, 10 * 10 ** 6, method);
        }

        // Verify all payments recorded
        PayvergePayments.AlternativePayment[] memory altPayments = payments.getBillAlternativePayments(bigBillId);
    ...
    function testAlternativePaymentGasLimits() public {
        ...
        vm.prank(billManager);
        payments.markAlternativePayment(gasTestBillId, customer1, 10 * 10 ** 6, PayvergePayments.PaymentMethod.CASH);
        ...
        for (uint256 i = 0; i < 10; i++) {
            vm.prank(billManager);
            payments.markAlternativePayment(
                gasTestBillId, address(uint160(2000 + i)), 10 * 10 ** 6, PayvergePayments.PaymentMethod.CASH
            );
        }

        uint256 gasUsed11 = gasleft();
        vm.prank(billManager);
        payments.markAlternativePayment(gasTestBillId, customer2, 10 * 10 ** 6, PayvergePayments.PaymentMethod.CASH);
    ...
    function testAlternativePaymentParticipantTracking() public {
        ...
        vm.prank(billManager);
        payments.markAlternativePayment(testBillId, customer2, 10 * 10 ** 6, PayvergePayments.PaymentMethod.CARD);
    ...
    function testAlternativePaymentEventEmission() public {
        ...
        emit PayvergePayments.AlternativePaymentMarked(
            testBillId, customer1, 50 * 10 ** 6, PayvergePayments.PaymentMethod.CASH, billManager
        );
    ...
    function testAlternativePaymentMaxAmount() public {
        ...
        vm.prank(billManager);
        payments.markAlternativePayment(maxBillId, customer1, maxAmount, PayvergePayments.PaymentMethod.CASH);
    ...
    function testAlternativePaymentMethodEnumBoundaries() public {
        ...
        for (uint256 i = 0; i < methods.length; i++) {
            ...
            vm.prank(billManager);
            payments.markAlternativePayment(testBillId, customer, 10 * 10 ** 6, methods[i]);
    ...
    function testAlternativePaymentTimestampAccuracy() public {
        ...
        vm.prank(billManager);
        payments.markAlternativePayment(testBillId, customer1, 25 * 10 ** 6, PayvergePayments.PaymentMethod.CASH);

        // Advance time
        vm.warp(block.timestamp + 3600); // 1 hour later

        vm.prank(billManager);
        payments.markAlternativePayment(testBillId, customer2, 25 * 10 ** 6, PayvergePayments.PaymentMethod.CARD);
    ...
    function testAlternativePaymentStorageEfficiency() public {
        ...
        // Verify all payments recorded
        PayvergePayments.AlternativePayment[] memory altPayments = payments.getBillAlternativePayments(storageBillId);
