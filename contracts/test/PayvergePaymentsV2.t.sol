...
contract PayvergePaymentsV2Test is Test {
    ...
    function testBusinessVerification() public {
        ...
        (string memory name, address businessOwner, address paymentAddr, address tippingAddr, uint256 regTime, bool isActive, uint256 totalVol, uint256 totalPay) = payverge.businessInfo(business1);
    ...
    function testCreateBill() public {
        ...
        assertEq(uint256(bill.status), uint256(PayvergePaymentsV2.BillStatus.Active));
    }
    ...
    function testProcessPayment() public {
        ...
        assertEq(uint256(bill.status), uint256(PayvergePaymentsV2.BillStatus.Paid));
    }
    ...
    function testReentrancyProtection() public {
        ...
        vm.prank(customer1);
        vm.expectRevert(abi.encodeWithSelector(PayvergePaymentsV2.BillAlreadyPaid.selector, billId));
    ...
    function testDailyLimits() public {
        ...
        vm.prank(customer1);
        vm.expectRevert(abi.encodeWithSelector(PayvergePaymentsV2.DailyLimitExceeded.selector, dailyLimit, 30 * 10**6 + BILL_AMOUNT));
        payverge.processPayment(billId2, BILL_AMOUNT, 0);
    }

    function testCircuitBreaker() public {
        uint256 threshold = 100 * 10**6; // $100 threshold
    ...
    function testZeroAmountPayment() public {
        ...
        vm.prank(customer1);
        vm.expectRevert(abi.encodeWithSelector(PayvergePaymentsV2.InvalidAmount.selector, 0));
    ...
    function testMinimumPaymentAmount() public {
        ...
        vm.prank(business1);
        vm.expectRevert(abi.encodeWithSelector(PayvergePaymentsV2.InvalidAmount.selector, smallAmount));
    ...
    function testMaximumPaymentAmount() public {
        ...
        vm.prank(business1);
        vm.expectRevert(abi.encodeWithSelector(PayvergePaymentsV2.InvalidAmount.selector, largeAmount));
    ...
    function testExcessivePayment() public {
        ...
        vm.prank(customer1);
        vm.expectRevert(abi.encodeWithSelector(PayvergePaymentsV2.ExcessivePayment.selector, BILL_AMOUNT, excessiveAmount));
    ...
    function testExcessiveTip() public {
        ...
        vm.prank(customer1);
        vm.expectRevert(abi.encodeWithSelector(PayvergePaymentsV2.InvalidAmount.selector, excessiveTip));
    ...
    function testNonExistentBill() public {
        ...
        vm.prank(customer1);
        vm.expectRevert(abi.encodeWithSelector(PayvergePaymentsV2.BillNotFound.selector, fakeBillId));
    ...
    function testDuplicateBillCreation() public {
        ...
        vm.prank(business1);
        vm.expectRevert(abi.encodeWithSelector(PayvergePaymentsV2.BillNotFound.selector, billId));
        payverge.createBill(billId, BILL_AMOUNT, "{}");
    }
    ...
    function testPlatformFeeUpdate() public {
        ...
        vm.prank(owner);
        vm.expectRevert(abi.encodeWithSelector(PayvergePaymentsV2.InvalidFeeRate.selector, 1001));
    ...
    function testUpgradeability() public {
        ...
        PayvergePaymentsV2 newImplementation = new PayvergePaymentsV2();
    ...
    function testMultipleBusinessesAndCustomers() public {
        ...
        PayvergePaymentsV2.Bill memory bill1 = payverge.getBill(billId1);
        PayvergePaymentsV2.Bill memory bill2 = payverge.getBill(billId2);
