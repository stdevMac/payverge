...
contract DeployPayvergeEcosystem is Script {
    function run() external {
        ...
        (address referralsProxy, address profitSplitProxy) = _deployAuxiliaryContracts(
            usdcToken, 
            platformFeeRecipient, 
            deployer
        );
    ...
    function _deployAuxiliaryContracts(
        address usdcToken,
        address platformFeeRecipient,
        address deployer
    ) internal returns (address referralsProxy, address profitSplitProxy) {
