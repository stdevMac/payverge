...
export default function NotificationPreferencesForm({
  ...
  const preferences = [
    ...
    { key: "investment_enabled", label: t('profile.notificationsTab.preferencesForm.investmentOpportunities') },
    { key: "fleet_updates_enabled", label: t('profile.notificationsTab.preferencesForm.fleetUpdates') },
    { key: "car_purchase_enabled", label: t('profile.notificationsTab.preferencesForm.carPurchase') },
    { key: "car_sale_enabled", label: t('profile.notificationsTab.preferencesForm.carSale') },
    { key: "car_status_enabled", label: t('profile.notificationsTab.preferencesForm.carStatus') },
    { key: "rewards_enabled", label: t('profile.notificationsTab.preferencesForm.rewards') },
    { key: "dividends_enabled", label: t('profile.notificationsTab.preferencesForm.dividends') },
