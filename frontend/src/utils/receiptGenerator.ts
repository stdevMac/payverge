...
export interface ReceiptData {
  ...
  generatedAt: string;
  googleReviewLink?: string; // Google review link for the business
  items?: Array<{
    id: string;
    name: string;
    price: number;
...
<body>
    <div class="receipt">
        ...
        <div class="footer">
            ...
            <div style="margin-bottom: 20px; padding: 15px; background: #e8f5e8; border: 2px solid #4caf50; border-radius: 8px;">
                <h3 style="margin: 0 0 8px 0; color: #2e7d32; font-size: 18px;">🌟 How was your experience?</h3>
                <p style="margin: 0 0 12px 0; color: #2e7d32; font-size: 14px;">
                    Your feedback helps ${data.businessName} improve their service!
                </p>
                <a href="${data.googleReviewLink}" 
                   target="_blank" 
                   style="display: inline-block; background: #4caf50; color: white; padding: 10px 20px; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 14px;">
